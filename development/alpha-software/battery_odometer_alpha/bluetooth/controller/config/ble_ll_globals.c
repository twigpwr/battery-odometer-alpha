...
#define gChanSelAlgo2SupportMask_c  (0x1U << 0x6U)
...
#if gLlUseChanSelAlgo2_d
#define gChanSelAlgo2SupportVal_c (gChanSelAlgo2SupportMask_c)
#else
#define gChanSelAlgo2SupportVal_c (0x0U)
#endif
...
GCOV_CONST bleCtrlConfigParam appConfig =
{
    ...
    .gBle5FeatureMask1_c = gExtAdvFeatureSupportMask_c | gPerAdvFeatureSupportMask_c | gChanSelAlgo2SupportMask_c,
    .gBle5FeatureEnable1_c = gExtAdvFeatureSupportVal_c | gPerAdvFeatureSupportVal_c | gChanSelAlgo2SupportVal_c,
    ...
    .ll_invalid_pdu_handling_type = gLlInvalidPduHandlingType_c
};
