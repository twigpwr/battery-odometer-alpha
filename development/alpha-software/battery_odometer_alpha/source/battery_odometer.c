...
*************************************************************************************
************************************************************************************/
#define mSpeedCadenceReportInterval_c   (1000U)      /* Speed and Cadence report interval in miliseconds  */
...
static odoConfig_t odometerService = {(uint16_t)service_odometer};
...
static void BleApp_Config(void)
{
    ...
    mOdoMeasurementTimerId =  TMR_AllocateTimer();
...
static void BleApp_ConnectionCallback (deviceId_t peerDeviceId, gapConnectionEvent_t* pConnectionEvent)
{
    ...
    switch (pConnectionEvent->eventType)
    {
        case gConnEvtConnected_c:
        {
            ...
            /* Start odometer measurements */
			(void)TMR_StartLowPowerTimer(mOdoMeasurementTimerId, gTmrLowPowerIntervalMillisTimer_c,
					   1000, OdoMeasurementTimerCallback, NULL);
        }
        break;
