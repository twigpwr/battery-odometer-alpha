...
#define gLEDsOnTargetBoardDefault_c     4U
#endif

/*
* Name: gLEDsOnTargetBoardCnt_c
...
#warning " gLEDsOnTargetBoardCnt_c not defined, set to gLEDsOnTargetBoardDefault_c"
#else
#if ( gLEDsOnTargetBoardCnt_c > gLEDsOnTargetBoardDefault_c) || (gLEDsOnTargetBoardCnt_c==0)
#undef gLEDsOnTargetBoardCnt_c
#define gLEDsOnTargetBoardCnt_c     gLEDsOnTargetBoardDefault_c
#warning "gLEDsOnTargetBoardCnt_c value defined is not supported, set to gLEDsOnTargetBoardDefault_c"
#endif
#endif
...
#define gLedRgbEnabled_d               0U
    ...
    */
    ...
    #define gRgbLedDimmingEnabled_d    FALSE
        ...
        #define gRgbLedDimDefaultInterval_c    3U  /* seconds */
        #define gRgbLedDimMaxInterval_c       10U  /* seconds */
        #define gRgbLedDimTimerTimeout_c      50U /* milliseconds */
    #endif
    ...
    /* Timer channels used for PWM */
        ...
        #define gGreenLedPwmTimerChannel_c      1U
    #endif
    #ifndef gBlueLedPwmTimerChannel_c
        #define gBlueLedPwmTimerChannel_c       2U
    #endif
    /* Index into the ledPins[] array */
        ...
        #define gGreenLedIdx_c                  1U
    #endif
    #ifndef gBlueLedIdx_c
        #define gBlueLedIdx_c                   2U
    #endif
...
#define LED1_FLASH                      0x10U
#define LED2_FLASH                      0x20U
#define LED3_FLASH                      0x40U
#define LED4_FLASH                      0x80U
#define LED_FLASH_ALL                   0xF0U  /* flash all LEDs */

#define LED_MAX_RGB_VALUE_c             0xFFU

#if gLedRgbEnabled_d
#define LED_RGB                         ((1U<<gRedLedIdx_c)|(1U<<gGreenLedIdx_c)|(1U<<gBlueLedIdx_c))
#else
#define LED_RGB                         0x00
#endif
